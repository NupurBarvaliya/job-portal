...
<form name="frm" action="app/create-account.php" method="POST" autocomplete="off">
                <div class="row login-register-cover">
                    ...
                    <div class="text-center">
                            ...
                            <h2 class="mt-10 mb-5 text-brand-1">Employee Registration</h2>
                ...
                <div class="text-center">
                            <a class="font-sm text-muted mb-30">For Company Registration?</h4> </a><a href="cregister.php">Click Here</a>
