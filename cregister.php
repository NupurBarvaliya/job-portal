    ...
    <main class="main">
        <section class="pt-100 login-register">
            <div class="container">
                    ...
                    <div class="row login-register-cover">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
                            <div class="text-center">
                                ...
                                <h2 class="mt-10 mb-5 text-brand-1">Company Registration</h2>
                                <p class="font-sm text-muted mb-30">Sign Up and get access to all the features.</p>
                            </div>
                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter your company name" name="company"
                                    required type="text">
                            </div></br>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Eg: Booking/Travel, Computer Software etc"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Min 8 and Max 20 characters" name="password"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Re-type password again" name="confirmpassword"
                                    required type="password">
                            </div></br>
                ...
                <center><button onclick="return val();" type="submit" name="reg_mode" class="btn btn-primary">Register</button></center></br>
            </form>
            <div class="text-center">
                <a class="font-sm text-muted mb-30">For Employee Registration?</a> <a href="eregister.php">Click Here</a>
                <center><a>OR</a><center>
                            <p class="font-sm text-muted mb-30">Already have an account? <a href="loginn.php">Sign In </a></p>
            </div>

            <div class="text-center text-muted"></div>
            </div>
            <div class="img-1 d-none d-lg-block"><img class="shape-1" src=indexx\storage\autho\img-1.png alt=""></div>
